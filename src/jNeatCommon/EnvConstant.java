...
public class EnvConstant {
	...
	// user directory for genome, population, user parameters, savings...
	public static String USERAPP_DIR = " "; //for example c://users/user
	...
	// name of sub-directory for images	and default parameters
	...
	public static String PREFIX_LAST_POPULATION = "lastPopulation";
	public static double PROBABILITY_OF_CONNECTION = 0.2;
	public static boolean RECURSION = false; 
	public static int SIMULATION_FROM_CLASS = 2; // simulazione da classe
	public static int SIMULATION_FROM_FILE = 1; // simulazione da file
	...
	//
	public static String PREFIX_INIT_POPULATION = "initpopulation";
	...
	public static String CURRENT_POPULATION_VIEW = "xxx";
	
	// 01.06.2002 : first organism winner 
