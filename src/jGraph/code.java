...
public class code {
	...
	// tipo ereditato dall'oggetto o forzato in caso di oggetto dummy : Vertex,
	// line...
	public int tipo;
	...
	/**
	 * costruttore di un code di tipo nodo passando riferimento a Vertex passato
	 *
	 */
	public code(Vertex _p, int t) {
		...
		if (t == CodeConstant.NODO_R) {
			...
			/*
			 * if (_ed.weight >= 0) c = new Color(0, 32, 128); else c = new
			 * Color(196, 0, 0);
			 */
		}
		name = 0;
	...
	public code(int x1, int y1, int x2, int y2, int t, int _sign) {
		...
		/*
		 * if (sign >= 0) c = new Color(0,32,128);
		 */
		name = 0;
		is_empty = true;
	}
	...
	public code(Vertex _p1, Vertex _p2, int t, int sign) {
		...
		/*
		 * if (sign >= 0) c = new Color(0,32,128); else c = new Color(196,0,0);
		 */
	...
	public code(int x1, int y1, String _s, int _codeColor) {
		...
		/*
		 * if (_codeColor >= 0) c = new Color(0, 32, 128); else c = new
		 * Color(196, 0, 0);
		 */
