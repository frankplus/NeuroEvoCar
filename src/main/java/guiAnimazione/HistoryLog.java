...
/**
 * Questo pannello viene stampato in basso e mostra il log dove vengono stampati
 * gli stati di esecuzione della simulazione e della impostazione dei parametri
 */
public class HistoryLog extends JPanel {
    private static final long serialVersionUID = 1L;
    private JTextArea textArea1;
    private JScrollPane paneScroll1;
    private JLabel curr_status = new JLabel("OK");
    ...
    public HistoryLog() {
        ...
        paneScroll1.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        // paneScroll1.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 1));
        paneScroll1.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(1, 1, 1, 1),
