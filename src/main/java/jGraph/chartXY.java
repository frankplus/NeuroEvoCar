...
public class chartXY extends JPanel {
	...
	public chartXY() {
		/*
		 * super(); // setOpaque(false); // we don't paint all our bits
		 * setLayout(new BorderLayout());
		 * setBorder(BorderFactory.createLineBorder(Color.black)); initialize();
		 */
		// super();
	...
	private void initialize() {
		/*
		 * try { setSize(400,400); d_axis_x = " axis  X"; d_axis_y = " axis  Y";
		 * 
	...
	/**
	 * Insert the method's description here. Creation date: (16/02/2002 8.39.54)
	 */
	 ...
	 * carica grafo
	 */
	public void setGrafo(Vector<code> v, String s) {
	...
	/**
	 * se true gli assi sono visualizzati altrimenti no per default gli assi
	 * sono visualizzati
	 */
	 ...
	 * carica grafo
	 */
	public void setGrafo(Vector<code> v) {
	...
	public void drawCode() {
		...
		Comparator<code> cmp = new order_code();
		Collections.sort(azioni, cmp);

		/*
		 * System.out.print("\n ox= "+ox); System.out.print("\n oy= "+oy);
		 * System.out.print("\n graph_axis= "+graph_axis); System.out.print(
		 * "\n graph_k   = "+graph_k); System.out.print("\n graph_kx   = "+kx);
		 * System.out.print("\n graph_ky   = "+ky);
		 */
		...
		for (int j = 0; j < azioni.size(); j++) {
			...
			if (_e.tipo == CodeConstant.DESCRIPTOR) {
				...
				// System.out.print("\n -> normal descriptor ");
				/*
				 * px = convertXtoScreen(_e.getx() * kx + ox); py =
				 * convertYtoScreen(_e.gety() * ky + oy);
				 */

				px = graph_kx_span + _e.getx() * kx;
				; // + nx2*kx;
			...
			if (_e.tipo == CodeConstant.NODO_R) {
				...
				px = graph_kx_span + _e.getx() * kx - rx / 8;
				; // + nx2*kx;
				py = (graph_ky_span + graph_axis_y) - (_e.gety() * ky + ry2); // -
																				// ny2
																				// ;
			...
			if (_e.tipo == CodeConstant.NODO_N) {
				...
				new Color(126, 177, 218);
				new Color(224, 85, 106);

				px = graph_kx_span + _e.getx() * kx - rx / 2;
				; // + nx2*kx;
				py = (graph_ky_span + graph_axis_y) - _e.gety() * ky - ry / 2; // -
																				// ny2
																				// ;

				xs = graph_kx_span + _e.getx() * kx - rx / 2 + ((rx - lengthS) / 2);
				; // + nx2*kx;
				ys = (graph_ky_span + graph_axis_y) - _e.gety() * ky + 4; // -
																			// ny2
																			// ;
	...
	public void drawTitle() {
		...
		/*
		 * px = (int) (kx_left + (double) ( (max_x * kx ) / 2.0)) - lls1 ; py =
		 * (int) ky_top;
		 */
		double ddm = ((max_x * kx) / 2.0) - lls1;

		/*
		 * System.out.print("\n ddm = "+ddm); System.out.print("\n max_x = "
		 * +max_x); System.out.print("\n kx = "+kx);
		 */
	...
	public void drawGrid() {
		...
		Stroke stroke = new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, new float[] { 1, 2 }, 0);
		g2.setStroke(stroke);
	...
	/**
	 * Inserire qui la descrizione del metodo. Data di creazione: (16/06/02
	 * 15.22.01)
	 */
